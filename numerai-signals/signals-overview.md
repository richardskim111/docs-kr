...
제출한 시그널에 자신이 있는 경우 corr 또는 corr + mmc에 NMR을 스테이킹 할 수 있습니다. 스테이킹이란 NMR을 이더리움 블록체인의 스마트 컨트랙트에 고정하는 것을 의미합니다. 참가자들은 뉴머라이는 스테이킹된 NMR에 제출된 시그널의 퍼포먼스에 따라 더 많은 NMR을 얻거나 잃을 수 있습니다.
